...
public class AppConstants {
   ...
   */
  public static final String WEB_CLIENT_ID = "241314623881-d3q6f6utc8vu4rqv7evsmhn524e361t9.apps.googleusercontent.com";
  public static final String ANDROID_CLIENT_ID = "241314623881-qp7s4bpc8hlbj4ejmrp828p9o9ua65gr.apps.googleusercontent.com";
  /**
  ...
  public static Helloworld getApiServiceHandle(@Nullable GoogleAccountCredential credential) {
    ...
    helloWorld.setApplicationName("Some crazy App Name");
    helloWorld.setRootUrl("https://englishsharing-1041.appspot.com//_ah/api/");
    Log.v(LOG_TAG, "Helloworld getApiServiceHandle :" + helloWorld);
